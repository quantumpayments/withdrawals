                ...
                if (err) {
                  ...
                  wc.getBalance(depURI, sequelize, config, function(err, inledger) {
                    if (err) {
                      ...
                      res.write('<br>\n');
                      res.write('Amount : ' + req.body.amount );
                      res.write('<br>\n');
                      res.write('Address : ' + req.body.address );
                      res.write('<br>\n');
                      res.write('Sent to inbox!' );
                      res.write('<br>\n');

                      sendToInbox(inbox, '<> <urn:string:addres> "'+ req.body.address +'" ; <urn:string:amount> '+ req.body.amount +' ; <urn:string:webid> <'+ req.session.userId +'> . ')
